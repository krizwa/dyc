...
<div id="carouselCarousel2" class="lrgSlider rsDefault">
	<div id="animationDC50_Benefit_CapturesMoreDust" class="animation" data-trackingname="dc50_benefit_capturesmoredust">
		<div class="lrgSlider" style="background: url('images-mobile/DC50_Cyclone_Benefit.png') no-repeat center;position: relative; ">
			<div class="aniContainer" style="position: absolute; left: 560px; top: 270px; width: 320px;
				height: 368px; background: url('/dyson/medialibrary/Group/Carousels/Animation Sprites/DC5 sprites.ashx.png') no-repeat;">
			</div>

			<!-- 
			TODO: 
			~ measure the image height and provide as a padding-top
			~ remove class 'SlideContentLeftAligned' 
			-->
			<div class="videoContentOverlay rsABlock slideContentBlock  " data-move-effect="left" data-move-offset="20px" style="left: 80px; padding-top: 368px; z-index: 1">
